...
_depending on how the cluster was set up, you have to look at different places to find the certificates. kubeadm deployes the different components as Pods._
![hrd](../../images/hrd.PNG)
...
- View logs using docker ps and docker logs
  ...
  or (new, copied from video tutorial)
