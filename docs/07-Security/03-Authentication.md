...
#### There are different users that may be accessing the cluster - security of end users who access the applications deployed on the cluster is managed by the applications themselves internally
...
## Authentication Mechanisms - Basic (NOT recommended)
