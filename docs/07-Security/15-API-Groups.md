...
- These APIs are categorized into two categories:
...
**Kube-proxy** is used to enable connectivity between the pods and services across different nodes in the cluster.
**Kubectl-proxy** is a http proxy service created by kubectl utility to access the kube-apiserver.
